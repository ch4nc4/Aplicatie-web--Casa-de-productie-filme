...
<head>
    ...
    <title>Useri - Casa de Producție Filme</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="header">
            <div class="title">Gestionare Useri</div>
            <div class="subtitle">Operațiuni disponibile</div>
        </div>
        
        <div class="navigation">
            <a href="/users/show" class="btn">
                Vizualizează toti userii
            </a>
